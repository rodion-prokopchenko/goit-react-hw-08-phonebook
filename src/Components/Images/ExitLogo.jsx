import s from "./ExitLogo.module.css";

export default function ExitLogo({ exit }) {
  return (
    <>
      <svg
        className={s.exitLogo}
        onClick={exit}
        version="1.1"
        id="Capa_1"
      ...
      >
        <path
          d="M54.924,23.618c-0.051-0.123-0.125-0.234-0.217-0.327L42.708,11.293c-0.391-0.391-1.023-0.391-1.414,0s-0.391,1.023,0,1.414
